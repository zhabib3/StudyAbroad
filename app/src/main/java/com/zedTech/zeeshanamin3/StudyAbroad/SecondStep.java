...
public class SecondStep extends AppCompatActivity {
    ...
    private void addDrawerItems() {
        ...
        StepNavList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0:
                        Intent firstActIntent = new Intent(SecondStep.this, FirstStep.class);
                        startActivity(firstActIntent);

                        break;

                    case 1:
                        Intent secondActIntent = new Intent(SecondStep.this, SecondStep.class);
                        startActivity(secondActIntent);

                        break;

                    case 2:
                        Intent thirdActIntent = new Intent(SecondStep.this, ThirdStep.class);
                        startActivity(thirdActIntent);

                        break;

                    case 3:
                        Intent fourthActIntent = new Intent(SecondStep.this, FourthStep.class);
                        startActivity(fourthActIntent);

                        break;

                    case 4:
                        Intent fifthActIntent = new Intent(SecondStep.this, FifthStep.class);
                        startActivity(fifthActIntent);

                        break;

                    case 5:
                        Intent sixthActIntent = new Intent(SecondStep.this, SixthStep.class);
    ...
    public void nextStep(View view) {
        ...
        CheckBox secondStepCheckbox = (CheckBox) findViewById(R.id.second_step_checkbox);
        if (secondStepCheckbox.isChecked() == false) {
            CheckBox secondStepCheckBox = (CheckBox) findViewById(R.id.second_step_checkbox);
            secondStepCheckBox.setText(checkBoxText);
        }

        else {
            //Starts the ThirdStep Activity
